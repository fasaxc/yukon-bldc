...
class Motor:
    ...
    def __init__(
        ...
        self._motor_pwms = [PWM(Pin(n)) for n in range(first_gpio_num, first_gpio_num+3)]
    ...
    def calibrate(self):
        ...
        print("Calibration interval A = {} = {} deg".format(angle1, angle1*360/4096))
        ...
        print("Calibration interval B = {} = {} deg".format(angle2, angle2*360/4096))
    ...
    def _read_pwm_slow(self) -> int:
        ...
        while reads_needed>0:
            ...
            if machine.mem32[self._sensor_debug_addr] & self._sensor_rx_stall_mask:
                ...
                machine.mem32[self._sensor_debug_addr+ 0x3000] = self._sensor_rx_stall_mask
